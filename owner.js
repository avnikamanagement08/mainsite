...
const MOCK_ORDERS = [
  {
    ...
    items: [
      { id: "p1-6-yellowgold-diamond", name: "Meera Anti-Tarnish Kundan Chandbalis", price: 149.00, quantity: 1, category: "Earrings", image: "images/earrings/1/WhatsApp Image 2026-08-05 at 7.11.41 PM.jpeg" }
    ],
    subtotal: 149.00,
    shipping: 50.00,
    discount: 0.00,
  ...
  },
  {
    ...
    payment_mode: "cod",
    items: [
      { id: "p2-7-yellowgold-emerald", name: "Aura Celestial Hoops", price: 149.00, quantity: 1, category: "Earrings", image: "images/earrings/2/WhatsApp Image 2026-08-05 at 7.11.36 PM.jpeg" }
    ],
    subtotal: 149.00,
    shipping: 50.00,
    discount: 0.00,
...
async function fetchInventoryData() {
  ...
  inventory = Object.keys(simInv).map(key => {
    ...
    return {
      ...
      product_id: parts[0],
      size: parts[1],
      metal: parts[2] === 'yellowgold' ? 'Gold-Tone' : parts[2] === 'rosegold' ? 'Rose Gold-Tone' : 'Platinum',
  ...
  if (products.length === 0) {
    ...
    if (cached) {
      ...
      products = [
        ...
        { id: "p3", name: "Ziya Simulated Emerald Drop Jhumkas", category: "Earrings", image: "images/earrings/3/WhatsApp Image 2026-08-05 at 7.11.37 PM.jpeg", description: "Fusion dangle jhumkas with vibrant simulated emerald drops suspended from a micro-pave cubic zirconia floral stud. Finished in a premium gold-tone. Features advanced anti-tarnish protection for lasting color. Extremely lightweight and comfortable.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p4", name: "Avni Royal Kundan Pearl Drops", category: "Earrings", image: "images/earrings/4/WhatsApp Image 2026-08-05 at 7.11.43 PM.jpeg", description: "Regal drop earrings featuring hand-set Kundan stones and suspended organic shell pearls. Finished in an antique gold-tone. Protected with an anti-tarnish barrier and designed for long-lasting wear. The perfect accessory for wedding and bridal wear.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p5", name: "Lumina Premium CZ Solitaire Studs", category: "Earrings", image: "images/earrings/5/WhatsApp Image 2026-06-15 at 11.04.50 PM.jpeg", description: "Classic four-prong stud earrings holding flawless AAAAA-grade simulated cubic zirconia solitaires. Finished in a premium silver-tone. Anti-tarnish coated for lasting color protection. Versatile and timeless, ideal for office wear and special occasions.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p6", name: "Tara Rose Gold Starburst Dangles", category: "Earrings", image: "images/earrings/6/WhatsApp Image 2026-08-04 at 7.27.54 PM.jpeg", description: "Elegant starburst danglers featuring pave-set CZ stone arrays that capture and reflect light. Finished in highly polished rose gold-tone. Includes premium anti-tarnish coating for lasting color protection. Comfortable posts make them perfect for daily wear.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p7", name: "Nisha Geometric Drops", category: "Earrings", image: "images/earrings/7/WhatsApp Image 2026-06-15 at 11.04.48 PM (2).jpeg", description: "Chic geometric hexagonal drop earrings with an elegant ribbed/shell design top stud. Fully anti-tarnish treated with a high-shine yellow gold finish over a premium base alloy. Modern, bold, and extremely lightweight.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p8", name: "Riya Twisted Hoops", category: "Earrings", image: "images/earrings/8/WhatsApp Image 2026-08-05 at 7.11.39 PM.jpeg", description: "Stunning twisted rope hoop earrings finished in a premium gold-tone. Comes with a secure click-lock post. Sweat-proof, waterproof, anti-tarnish treated, and perfect for adding texture to any look.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p9", name: "Kriti Floral Jhumkas", category: "Earrings", image: "images/earrings/9/WhatsApp Image 2026-08-04 at 7.31.27 PM.jpeg", description: "Exquisite floral motif stud earrings adorned with intricate hand-set Kundan stones and delicate pearl drops. Finished in highly polished warm gold-tone. Coated with our signature anti-tarnish shield.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p10", name: "Gauri Pearl Cascade Jhumkas", category: "Earrings", image: "images/earrings/10/WhatsApp Image 2026-08-04 at 7.33.56 PM.jpeg", description: "Traditional style jhumka earrings featuring a detailed gold-tone bell-cap embellished with cascading clusters of faux pearls. Offers a lightweight fit, premium alloy posts, and superior tarnish resistance.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p11", name: "Veda Pearl Hoop Dangles", category: "Earrings", image: "images/earrings/11/WhatsApp Image 2026-08-05 at 7.11.39 PM.jpeg", description: "Chic modern gold-plated hoop earrings featuring elegant suspended organic pearls. Finished with a premium anti-tarnish coating. Extremely lightweight and versatile.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p12", name: "Aditi Royal Drop Earrings", category: "Earrings", image: "images/earrings/12/WhatsApp Image 2026-08-05 at 7.11.40 PM.jpeg", description: "Delicately handcrafted gold-plated drop earrings adorned with sparkling cluster CZ stones. Anti-tarnish coated for lasting color. Perfect for special occasions.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 }
      ];
