...
const MOCK_ORDERS = [
  ...
  },
  {
    ...
    payment_mode: "cod",
    items: [
      { id: "p2-7-yellowgold-emerald", name: "Aura Celestial Hoops", price: 149.00, quantity: 1, category: "Earrings", image: "images/earrings/2/WhatsApp Image 2026-06-15 at 11.04.48 PM.jpeg" }
    ],
    subtotal: 149.00,
    shipping: 50.00,
    discount: 0.00,
  ...
  if (products.length === 0) {
    ...
    if (cached) {
      ...
      products = [
        ...
        { id: "p3", name: "Ziya Simulated Emerald Drop Jhumkas", category: "Earrings", image: "images/earrings/3/WhatsApp Image 2026-06-15 at 11.04.51 PM (1).jpeg", description: "Fusion dangle jhumkas with vibrant simulated emerald drops suspended from a micro-pave cubic zirconia floral stud. Finished in a premium gold-tone. Features advanced anti-tarnish protection for lasting color. Extremely lightweight and comfortable.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
        { id: "p4", name: "Avni Royal Kundan Pearl Drops", category: "Earrings", image: "images/earrings/4/WhatsApp Image 2026-06-12 at 2.19.55 PM.jpeg", description: "Regal drop earrings featuring hand-set Kundan stones and suspended organic shell pearls. Finished in an antique gold-tone. Protected with an anti-tarnish barrier and designed for long-lasting wear. The perfect accessory for wedding and bridal wear.", base_price_making: 149, gold_weight_grams: 0, gemstone_cost: 0, stock: 10 },
